...
public class RestClient {
	...
	public CloseableHttpResponse patch(String url, String entityString, HashMap<String, String> headerMap)
			throws ClientProtocolException, IOException {
		CloseableHttpClient httpClient = HttpClients.createDefault();
		HttpPatch httppatch = new HttpPatch(url); // http post request
		httppatch.setEntity(new StringEntity(entityString)); // for payload
	...
	public CloseableHttpResponse delete(String url, String entityString, HashMap<String, String> headerMap)
			throws ClientProtocolException, IOException {
		CloseableHttpClient httpClient = HttpClients.createDefault();
		HttpDelete HttpDelete = new HttpDelete(url); // http post request
